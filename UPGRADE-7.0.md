...
- The API Limiter was removed temporarily. Shoud be added back before the M7-stable is released. https://github.com/mautic/mautic/pull/14876C
- The `track_by_tracking_url` configuration setting has been removed. Contacts were from some version identified by the `ct` parameter in tracking URLs by default.
